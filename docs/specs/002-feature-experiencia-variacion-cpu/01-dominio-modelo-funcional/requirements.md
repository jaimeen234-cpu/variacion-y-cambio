...
| DR-4 | `docs/trd/trd.md:256-257`, `:320-324`, `:350`, `:407-424` — 28 líneas mencionan el concepto | módulo `consumption` completo: `Aparato`, `PerfilUso`, `Tarifa`, `kWh`, workflow W2, reglas BR-6/BR-7/BR-8 | PRD v0.2 **O1** retira el módulo de consumo y costo del alcance |
