# CLAUDE.md — Variación y Cambio

> Guía raíz para Claude Code en este repositorio. Es el espejo de [`AGENTS.md`](AGENTS.md): **ambos archivos deben decir lo mismo**; si divergen, gana `AGENTS.md` y se corrige este.
